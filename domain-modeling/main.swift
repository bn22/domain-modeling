...
checkMoneyAdd (13.0, amount: 10.0, currency : "EUR", tCurrency : "EUR", change : 3)
checkMoneyAdd (13.0, amount: 10.0, currency : nil, tCurrency : "EUR", change : 3)
print("")
print("//Subtracting Money///")
print("")
checkMoneySub (10.0, amount: 10.0, currency : "USD", tCurrency : "CAN", change : 2.5)
checkMoneySub (7.0, amount: 10.0, currency : "EUR", tCurrency : "EUR", change : 3)
checkMoneySub (13.0, amount: 10.0, currency : nil, tCurrency : "EUR", change : 3)
...
let b : Person? = Person(first : "Thomas", last: "Olson", currentJob: lawyer, currentSpouse: nil, ageNow: 23)
let c : Person? = Person(first : "Jim", last: "Olson", currentJob: lawyer, currentSpouse: nil, ageNow: 23)
...
printPerson("Lesile", last : "Olson", currentJob : lawyer, currentSpouse : nil, ageNow : 18, updateSpouse : b)
printPerson(nil, last : "Olson", currentJob : lawyer, currentSpouse : nil, ageNow : 18, updateSpouse : b)
printPerson("Lesile", last : "Olson", currentJob : lawyer, currentSpouse : nil, ageNow : nil, updateSpouse : b)
...
print("")
checkHouseholdIncome(120000, person1 : a, person2 : b, person3 : c)
checkHouseholdIncome(120000, person1 : nil, person2 : b, person3 : c)
checkHouseholdIncome(120000, person1 : a, person2 : nil, person3 : c)
...
haveChild(a, person2: nil, person3: c, firstName: "Daniel", lastName: "Dude")
